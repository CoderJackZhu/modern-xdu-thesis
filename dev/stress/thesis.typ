...
//
// 源：github.com/CoderJackZhu/MasterThesis —— 已通过学校格式检查的成品
...
#let (
  ...
  info: (
    ...
    supervisor: ("李卫斌", "教授"), supervisor-en: ("Li Weibin", "Professor"),
    enterprise-supervisor: ("扈慧强", "高级工程师"),
    enterprise-supervisor-en: ("Hu Huiqiang", "Senior Engineer"),

    department: "人工智能学院", department-en: "School of Artificial Intelligence",
