...
#let (
  ...
  info: (
    ...
    title-en: ("Deep Learning based Urban Traffic Flow Prediction",
    ...
    keywords: ("交通流量预测", "时空序列建模", "图神经网络", "注意力机制",
               "时间序列分析", "智能交通系统"),
    keywords-en: ("Traffic Flow Prediction", "Spatio-temporal Modeling",
                  "Graph Neural Networks", "Attention Mechanism",
                  "Time Series Analysis", "Intelligent Transportation"),
